...
class Instance:
    ...
    def compute_sol(self,T,hmax,temperature,len_taboo,start,mode):
        t1 = pfc()
        solution = CluVNS(self.maps,self.demands,self.v_capacities,T,hmax,temperature,len_taboo,start,mode)
        t2 = pfc()
